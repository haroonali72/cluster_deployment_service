...
func (c *AWSClusterController) Get() {
	...
	ctx.SendLogs("AWSClusterController: Get cluster with project id: "+projectId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) GetAll() {
	...
	ctx.SendLogs("AWSClusterController: GetAll clusters.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) Post() {
	...
	ctx.SendLogs("AWSClusterController: Post new cluster with name: "+cluster.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) Patch() {
	...
	ctx.SendLogs("AWSClusterController: Patch cluster with name: "+cluster.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) Delete() {
	...
	ctx.SendLogs("AWSClusterController: Delete cluster with project id: "+id, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) StartCluster() {
	...
	ctx.SendLogs("AWSNetworkController: StartCluster.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
	...
	ctx.SendLogs("AWSClusterController: Getting Cluster of project. "+projectId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
	...
	ctx.SendLogs("AWSClusterController: Creating Cluster. "+cluster.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) GetStatus() {
	...
	//=============================================================================//
	ctx.SendLogs("AWSNetworkController: FetchStatus.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
	...
	ctx.SendLogs("AWSClusterController: Fetch Cluster Status of project. "+projectId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) TerminateCluster() {
	...
	//=============================================================================//
	ctx.SendLogs("AWSNetworkController: TerminateCluster.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
	profileId := c.Ctx.Input.Header("X-Profile-Id")
	region, err := aws.GetRegion(token, projectId, *ctx)
	if err != nil {
		c.Ctx.Output.SetStatus(500)
	...
	ctx.SendLogs("AWSClusterController: Terminating Cluster. "+cluster.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSClusterController) GetAMI() {
	...
	//=============================================================================//
	ctx.SendLogs("AWSClusterController: FetchAMIs.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
	...
	ctx.SendLogs("AWSClusterController: Get Ami from AWS", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
