...
func (c *AWSTemplateController) Get() {
	...
	//=============================================================================//
	ctx.SendLogs("AWSTemplateController: Get template  id : "+templateId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSTemplateController) GetAll() {
	...
	//=============================================================================//
	ctx.SendLogs("AWSTemplateController: GetAll template.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AWSTemplateController) Post() {
	...
	ctx.SendLogs("AWSTemplateController: Post new template with name: "+template.Name, models.LOGGING_LEVEL_ERROR, string(models.Backend_Logging))
...
func (c *AWSTemplateController) Patch() {
	...
	//=============================================================================//
	ctx.SendLogs("AWSTemplateController: Patch template with template id : "+template.TemplateId, models.LOGGING_LEVEL_ERROR, string(models.Backend_Logging))
