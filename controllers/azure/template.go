...
func (c *AzureTemplateController) Get() {
	...
	ctx.SendLogs("AzureTemplateController: Get template with id: "+id, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureTemplateController) Post() {
	...
	ctx.SendLogs("AzureTemplateController: Post new template with name: "+template.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureTemplateController) Patch() {
	...
	ctx.SendLogs("AzureTemplateController: Patch template with id: "+template.TemplateId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureTemplateController) Delete() {
	...
	ctx.SendLogs("AzureTemplateController: Delete template with id: ", id, string(models.Backend_Logging))
