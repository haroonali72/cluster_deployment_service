...
func (c *AzureClusterController) Get() {
	...
	ctx.SendLogs("AZUREClusterController: Get cluster with project id "+projectId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureClusterController) Post() {
	...
	ctx.SendLogs("AzureClusterController: Post new cluster with name: "+cluster.Name, models.LOGGING_LEVEL_ERROR, string(models.Backend_Logging))
...
func (c *AzureClusterController) Patch() {
	...
	ctx.SendLogs("AzureClusterController: Patch cluster with name: "+cluster.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureClusterController) Delete() {
	...
	ctx.SendLogs("AzureClusterController: Delete cluster with project id: "+id, models.LOGGING_LEVEL_ERROR, string(models.Backend_Logging))
...
func (c *AzureClusterController) StartCluster() {
	...
	ctx.SendLogs("AzureClusterController: POST cluster with project id: "+projectId, models.LOGGING_LEVEL_ERROR, string(models.Backend_Logging))
	...
	ctx.SendLogs("AzureClusterController: Getting Cluster of project. "+projectId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
	...
	ctx.SendLogs("AzureClusterController: Creating Cluster. "+cluster.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureClusterController) GetStatus() {
	...
	ctx.SendLogs("AzureClusterController: Fetch Cluster Status of project. "+projectId, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureClusterController) TerminateCluster() {
	...
	ctx.SendLogs("AzureClusterController: TerminateCluster.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
	profileId := c.Ctx.Input.Header("X-Profile-Id")
	region, err := azure.GetRegion(token, projectId, *ctx)
	...
	ctx.SendLogs("AzureClusterController: Terminating Cluster. "+cluster.Name, models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
...
func (c *AzureClusterController) GetSSHKeys() {
	...
	//=============================================================================//
	ctx.SendLogs("AZUREClusterController: FetchExistingSSHKeys.", models.LOGGING_LEVEL_INFO, string(models.Backend_Logging))
