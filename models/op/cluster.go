...
type Cluster_Def struct {
	...
	Status          models.Type       `json:"status" bson:"status" validate:"eq=New|eq=new" description:"Cluster status can be New, Cluster Created, Cluster Terminated. By default value will be 'New' [readonly]"`
