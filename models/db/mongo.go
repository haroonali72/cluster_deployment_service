...
func GetMongoConf() mongConf {
	...
	conf.MongoAwsTemplateCollection = beego.AppConfig.String("mongo_doks_template_collection")
	conf.MongoAwsClusterCollection = beego.AppConfig.String("mongo_doks_cluster_collection")
