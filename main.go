...
func setEnv() {
	...
	os.Setenv("mongo_eks_cluster_collection", "eks_cluster")
	...
	os.Setenv("mongo_gke_running_cluster_collection", "gke_previous_cluster")
	...
	os.Setenv("network_url", "http://c4d741991dab.ngrok.io/")
	os.Setenv("vault_url", "http://167.172.6.79")
	os.Setenv("raccoon_url", "https://7060758688a0.ngrok.io")
	os.Setenv("rbac_url", "http://rbac-v2:7777")
