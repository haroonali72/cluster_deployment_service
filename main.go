...
func setEnv() {
	os.Setenv("ca_certificate", "/home/haroon/Downloads/mongoCA.crt")
	os.Setenv("client_cert", "/home/haroon/Downloads/weasel.crt")
	os.Setenv("client_pem", "/home/haroon/Downloads/weasel.pem")
